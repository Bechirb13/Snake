...
function setup() {
  // on charge le modèle
  classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/BAOIj84mU/model.json");
...
function keyPressed() {
  switch (keyCode) {
    ...
    case 40: // 40 à flèche du bas
      goDown();
      break;
      case 37: // 37 à flèche du gauche
      goLeft();
      break;
      case 39: // 39 à flèche droite
      goRight();
      break;
  }
}
